...
const InvoiceComponent = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  const InvoicePreview = ({ data }) => {
    const { name, address, apartment, phone, email, paymentMethod, items, deliveryCharge } = data;
    ...
    return (
      <div className="text-sm space-y-4 font-[NotoSerifBengali]">
        <div className="flex justify-between items-center border-b pb-2">
          <div>
            <h1 className="text-xl font-bold text-red-600">Fresh Cut Chicken Service</h1>
      ...
      <div className="w-full md:w-1/2 space-y-4">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <input type="number" className="border p-2" placeholder="Delivery Charge" value={form.deliveryCharge} onChange={(e) => setForm({ ...form, deliveryCharge: Number(e.target.value) })} />
